    ...
    <div class="header-top container-fuild hidden-xs">
      <div class="container">
        ...
        <div class="shejiao pull-right">
          <span class="glyphicon glyphicon-hand-right">&nbsp;期待您的来电</span>
...
<!--        <img src="@/assets/img/logo_black.png">-->
        <img src="@/assets/img/jinqiangmuye_logo.png">
      </div>
      <!-- 导航内容 -->
...
<!--        <img class="center-block" src="@/assets/img/logo_black.png" alt="logo">-->
        <img class="center-block" src="@/assets/img/jinqiangmuye_logo.png" alt="logo">
      </div>
      <!-- 导航栏 -->
