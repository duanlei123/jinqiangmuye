...
<!--          <img class="img-responsive" src="@/assets/img/img1.png" alt="大数据管理系统">-->
          <img class="img-responsive" src="@/assets/img/jqmy_index.jpg" style="height: 289px; width: 600px" alt="全屋定制">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          <h2 class="bigData-title">
            全屋定制
            <small>/ whole house customization </small>
          </h2>
          <p>对现代人来说，家具不仅是一种实用品，更代表了一种生活态度。全屋定制家具越来越受到消费者的认可。定制家具，既可以合理利用家中的各种空间，又能够和整个家居环境相匹配。如整体衣柜定制，可以将衣柜嵌入墙内，配上适宜的推拉门，衣柜就和整个装修风格浑然一体，并且还可以根据主人的个性特别定制，充分体现主人的品位</p>
          <p>全屋定制作为整体家具新的发展方向，虽然年轻，但是已经展示出了朝气蓬勃的发展实力，在不久的未来，全屋定制将在中国的整体家具市场，必然会成为主流。</p>
          <h2 class="bigData-device">家居设计及定制、安装等服务为一体的家居定制解决方案</h2>
      ...
      swiperList: [
        {
          ...
          img: require("@/assets/img/jqmy_banner1.png"),
          path: "",
          // title: '您身边的IT专家1',
          // content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        },
        {
          img: require("@/assets/img/jqmy_banner2.jpg"),
          path: "",
          // title: '您身边的IT专家2',
          // content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        },
        {
          img: require("@/assets/img/jqmy_banner3.png"),
          path: "",
          // title: '您身边的IT专家3',
          // content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        },
        {
          img: require("@/assets/img/jqmy_banner4.png"),
          path: "",
          // title: '您身边的IT专家4',
          // content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        }
      ...
      customerList: [
        {
          ...
          title: "您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。",
          content: "您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。"
        },
        {
